    ...
    <div>
        <div class="mt-2">
            <div class="relative">
                ...
                <input v-model="queryNoSerieEquipo" @keyup.enter="filterInputs()" type="text"
        ...
        <div class="mt-2">
            <div class="relative">
                ...
                <input v-model="queryModelo" @keyup.enter="filterInputs()" type="text" placeholder="Buscar por Modelo"
                    class="px-8 py-3 w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm">
            </div>
        </div>
    </div>
