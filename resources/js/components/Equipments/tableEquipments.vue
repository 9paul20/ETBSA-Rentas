                            ...
                            <td class="px-1 py-1">
                                <div class="flex justify-end gap-2">
                                    <icon-button color="text-green-500"
                                        ...
                                        :id="'Show_' + rowData.clvEquipment" :clv="rowData.clvEquipment" @click.prevent="show(
                                            getTitle(rowData.noSerieEquipo),
                                            getDescription(rowData.modelo, rowData.categoria.categoria, rowData.precioEquipo),
                                            'info',
                                        )" />
