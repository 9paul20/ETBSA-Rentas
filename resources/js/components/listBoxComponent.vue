    ...
    <div>
        <Listbox as="div" v-model="selected">
            <div class="relative mt-1">
                <ListboxButton
                    class="relative w-full cursor-default rounded-md border border-gray-300 bg-gray-100 py-2 pl-3 pr-10 text-left shadow-md focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500 sm:text-sm">
...
const selected = ref(people[props.selected]);
</script>
