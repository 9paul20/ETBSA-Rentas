    ...
    <div>
        ...
        <div class="mt-2">
            <div class="relative">
                ...
                <input v-model="queryClientName" @keyup.enter="filterInputs()" type="text"
        ...
        <div class="mt-2">
            <div class="relative">
                ...
                <input v-model="queryClientAP" @keyup.enter="filterInputs()" type="text"
                    placeholder="Buscar por Ape.Paterno Cliente"
                    class="px-8 py-3 w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm">
            </div>
        </div>
        <div class="mt-2">
            <div class="relative">
                ...
                <input v-model="queryClientAM" @keyup.enter="filterInputs()" type="text"
                    placeholder="Buscar por Ape.Materno Cliente"
                    class="px-8 py-3 w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm">
            </div>
        </div>
        <div class="mt-2">
