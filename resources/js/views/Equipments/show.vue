            ...
            <div
                ...
                <div class="flex items-center space-x-5">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-500">Con No.Serie <a class="text-gray-900">{{
                            equipmentObject.noSerieEquipo }}.</a> Adquirido el día <time
                                :datetime="equipmentObject.fechaAdquisicion">{{
                                    loader.transformarFecha(equipmentObject.fechaAdquisicion) }}</time>
                            <span class="text-gray-400 font-light">({{ mesesDespuesAdqEq }} meses desde su
                                compra)</span>
                        </p>
                    </div>
                </div>
            ...
            <div
                            ...
                            <div class="border-t border-gray-200 px-4 py-1 sm:px-6">
                                <dl class="grid grid-cols-1 gap-x-4 gap-y-1 sm:grid-cols-4">
                                    <div class="sm:col-span-1">
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900">
                                            <span
                                                ...
                                                <span
                                                    :class="`h-1.5 w-1.5 rounded-full ${equipmentObject.disponibilidad.bgColorSecondary}`"></span>
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <dd class="mt-1 text-xl text-gray-900">{{ equipmentObject.categoria.categoria }}
                                        </dd>
                                    </div>
                                    <div class="sm:col-span-1">
                                        <dt class="text-sm font-medium text-gray-700">Garantia Extendida</dt>
                                        <dd class="mt-1 text-xl text-gray-900">{{
                                            loader.transformarFecha(equipmentObject.fechaGarantiaExtendida) }}</dd>
                                    </div>
                                    <div class="sm:col-span-1">
                                        ...
                                        <dd class="mt-1 text-xl text-gray-900" v-if="equipmentObject.fechaVenta">{{
                                            loader.transformarFecha(equipmentObject.fechaVenta) }}</dd>
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <dd class="mt-1 text-xl text-gray-900"><span
                                                class="text-green-600 font-semibold">$</span>{{
                                                    loader.precioFormatter(precioEquipo) }}</dd>
                                    </div>
                                    <div class="sm:col-span-1">
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900">{{ noPagosRentasTotal }} mensualidades
                                            asignadas
                                        </dd>
                                        <dd class="mt-1 text-xl text-gray-900" v-if="sumPagosRentasTotal">
                                            <span class="text-gray-700 font-semibold">Total: </span><span
                                                class="text-green-600 font-semibold">$</span>{{
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900">{{ noPagosRentasPagados }} mensualidades
                                            pagadas
                                        </dd>
                                    ...
                                    <div class="text-right -my-6 sm:col-span-4">
                                        <div class="flex justify-end items-center"
                                            ...
                                            <h2
                                                ...
                                                MXN </h2>
                                            <div class="w-12 h-5 flex items-center bg-gray-200 rounded-full p-1 duration-200 ease-in-out"
                                                :class="{ 'bg-green-200': switchMXNToUSD }">
                                                <div class="bg-white w-4 h-4 rounded-full shadow-md transform duration-300 ease-in-out"
                                                    :class="{ 'translate-x-6': switchMXNToUSD, }"></div>
                                            </div>
                                            <h2
                                                :class="`text-xs ${!switchMXNToUSD ? 'text-gray-400' : 'text-gray-600 font-semibold'}`">
                                                 USD
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900">
                                            <span
                                                class="inline-flex items-center gap-1 rounded-full bg-green-100 px-2 py-1 text-xl font-semibold text-green-600"><span
                                                    class="text-green-600 font-semibold">$</span>{{
                                                        loader.precioFormatter(renta(1)) }}</span>
                                        </dd>
                                    </div>
                                    <div class="sm:col-span-1">
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900">
                                            <span
                                                class="inline-flex items-center gap-1 rounded-full bg-red-100 px-2 py-1 text-xl font-semibold text-red-600"><span
                                                    class="text-red-600 font-semibold">$</span>{{
                                                        loader.precioFormatter(sumGastosMensuales) }}</span>
                                        </dd>
                                    </div>
                                    <div class="sm:col-span-1"></div>
                                    <div class="sm:col-span-1"></div>
                                    <div class="sm:col-span-1">
                                        <dt class="text-sm font-medium text-gray-700">Acumulado de renta óptima
                                            <p /><span class="text-gray-500 font-light">(En el mes {{ mesesDespuesAdqEq
                                            }})</span>
                                        </dt>
                                        <dd class="mt-1 text-sm text-gray-900">
                                            <span
                                                class="inline-flex items-center gap-1 rounded-full bg-green-100 px-2 py-1 text-xl font-semibold text-green-600"><span
                                                    class="text-green-600 font-semibold">$</span>{{
                                                        loader.precioFormatter(renta(inputMes)) }}</span>
                                        </dd>
                                    </div>
                                    <div class="sm:col-span-1">
                                        <dt class="text-sm font-medium text-gray-700">Acumulado de Utilidad óptima <span
                                                class="text-gray-500 font-light">(En el mes {{ mesesDespuesAdqEq }})</span>
                                        </dt>
                                        <dd class="mt-1 text-sm text-gray-900">
                                            <span
                                                class="inline-flex items-center gap-1 rounded-full bg-green-100 px-2 py-1 text-xl font-semibold text-green-600"><span
                                                    class="text-green-600 font-semibold">$</span>{{
                                                        loader.precioFormatter(utilidad(inputMes)) }}</span>
                                        </dd>
                                    </div>
                                    <div class="sm:col-span-1">
                                        <dt class="text-sm font-medium text-gray-700">Costo actual óptimo <span
                                                class="text-gray-500 font-light">(En el mes {{ mesesDespuesAdqEq }})</span>
                                        </dt>
                                        <dd class="mt-1 text-sm text-gray-900">
                                            <span
                                                class="inline-flex items-center gap-1 rounded-full bg-green-100 px-2 py-1 text-xl font-semibold text-green-600"><span
                                                    class="text-green-600 font-semibold">$</span>{{
                                                        loader.precioFormatter(costo(inputMes)) }}</span>
                                        </dd>
                                    </div>
                                    <div class="sm:col-span-1">
                                        <dt class="text-sm font-medium text-gray-700">Valor comercial <span
                                                class="text-gray-500 font-light">(En el mes {{ mesesDespuesAdqEq }})</span>
                                        </dt>
                                        <dd class="mt-1 text-sm text-gray-900">
                                            <span
                                                class="inline-flex items-center gap-1 rounded-full bg-green-100 px-2 py-1 text-xl font-semibold text-green-600"><span
                                                    class="text-green-600 font-semibold">$</span>{{
                                                        loader.precioFormatter(conversiónMXNToUSD(precioVenta(inputMes))) }}</span>
                                        </dd>
                                    </div>
                                    ...
                                    <div class="sm:col-span-4 mb-6">
                                        <div class="transition rounded-lg mb-1 text-center bg-white mt-2">
                                            <span class="text-xl font-semibold text-gray-700 hover:cursor-pointer"
                                                @click="isOpen = !isOpen">
                                                {{ (isOpen) ? 'Cerrar' : 'Mostrar' }} detalles de los gastos
                                            </span>
                                                    ...
                                                    <nav class="isolate flex divide-x divide-gray-200 rounded-lg shadow"
                                                        ...
                                                        <a v-for="(tab, tabIdx) in tabs" :key="tab.name"
                                                            ...
                                                            <span aria-hidden="true"
                                                                :class="[tab.current ? 'bg-green-500' : 'bg-transparent', 'absolute inset-x-0 bottom-0 h-0.5']"></span>
                                                        </a>
                                                    </nav>
                                                </div>
                                                <div
                                                    ...
                                                    <div class="overflow-x-auto">
                                                        <TransitionGroup tag="div" name="list" mode="out-in">
                                                            <table
                                                                ...
                                                                <tbody class="divide-y divide-gray-200 border-t bg-white">
                                                                    <tr class="hover:bg-gray-100"
                                                                        ...
                                                                        :key="i">
                                                                        <th
                                                                            class="flex gap-1 px-3 py-2 font-normal text-gray-900">
                                                                            <div class="text-sm">
                                                                ...
                                                                <tbody class="divide-y divide-gray-200 border-t bg-white">
                                                                    <tr class="hover:bg-gray-100"
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <div class="text-red-500" v-else>Sin Descripción
                                                                            </div>
                                                                        </td>
                                                                        <td
                                                                            class="whitespace-nowrap px-3 py-2 text-sm text-gray-500">
                                                            ...
                                                            <div v-else class="text-center justify-center p-4">
                                                                <span class="text-lg font-medium text-gray-700 ">Sin
                                                                    Gastos {{ (tabs[0].current) ? 'Fijos' : '' ||
                                                                        (tabs[1].current) ? 'Variables' : '' ||
                                                                            (tabs[2].current) ? 'Mensuales' : '' }}</span>
                                                            </div>
                                                        </TransitionGroup>
                                                    </div>
                                                </div>
                    ...
                    <section aria-labelledby="notes-title">
                        <div class="bg-white shadow sm:overflow-hidden sm:rounded-lg">
                            <div class="divide-y divide-gray-200">
                                <div class="px-4 py-5 sm:px-6">
                                    <h2 id="notes-title" class="text-lg font-medium text-gray-900 text-center">Rentas
                                        Relacionadas al
                                        equipo</h2>
                                </div>
                                    ...
                                    <ul role="list" class="space-y-8" v-if="equipmentObject.renta.length > 0">
                                        <li v-for="(rent, i) in equipmentObject.renta" :key="rent.clvRenta">
                                            <div class="flex space-x-3">
                                                <div>
                                                    <div class="text-sm">
                                                        <a class="font-medium text-gray-900">Renta No.{{ i + 1 }}
                                                        </a>
                                                        <div class="px-3 inline-flex">
                                                            <span
                                                                ...
                                                                <span
                                                                    :class="`h-1.5 w-1.5 rounded-full ${rent.status_rent.bgColorSecondary}`"></span>
                                                                {{ rent.status_rent.estadoRenta }}
                                                            </span>
                                                        </div>
                                                    </div>
                                                    <div class="mt-1 text-sm text-gray-700">
                                                        <p><span class="font-semibold text-base">Información
                                                                Básica: </span><span class="font-normal">Esta renta empezó
                                                                el
                                                                <span class="font-semibold">{{
                                                                    loader.transformarFecha(rent.fecha_inicio) }}</span> y
                                                                terminó
                                                                el <span class="font-semibold">{{
                                                                    loader.transformarFecha(rent.fecha_fin) }}</span></span>
                                                        </p>
                                                        <p>Con <span class="font-semibold">{{ rent.payments_rents.length
                                                        }}</span> mensualidades:
                                                            <span v-if="equipmentObject.paymentsByStatus.Pagado"><span
                                                                    class="font-semibold">{{
                                                                        equipmentObject.paymentsByStatus.Pagado.payments.length
                                                                    }}</span>
                                                                Ya están pagadas,</span>
                                                            <span
                                                                v-if="equipmentObject.paymentsByStatus['Pendiente de pago']">
                                                                {{
                                                                    equipmentObject.paymentsByStatus['Pendiente de pago'].payments.length
                                                                }}
                                                                están pendientes, </span>
                                                        ...
                                                        <p>Cada mensualidad es de <span
                                                                class="text-green-600 font-semibold">$</span><span
                                                                class="font-semibold">{{
                                                                    loader.precioFormatter(Number(rent.payments_rents[0].pagoRenta)
                                                                        +
                                                                        Number(rent.payments_rents[0].ivaRenta)) }}</span></p>
                                                        <p class="font-semibold">Total: <span
                                                                class="text-green-600">$</span>{{
                                                                    loader.precioFormatter((Number(rent.payments_rents[0].pagoRenta)
                                                                        +
                                                                        Number(rent.payments_rents[0].ivaRenta)) *
                                                                        rent.payments_rents.length) }}</p>
                                                        <p class="font-semibold"
                                                            v-if="equipmentObject.paymentsByStatus.Pagado">Abonado: <span
                                                                class="text-green-600">$</span>{{
                                                                    loader.precioFormatter((Number(rent.payments_rents[0].pagoRenta)
                                                                        +
                                                                        Number(rent.payments_rents[0].ivaRenta)) *
                                                        ...
                                                        <p class="font-semibold"
                                                            v-if="equipmentObject.paymentsByStatus.Pagado && ((Number(rent.payments_rents[0].pagoRenta)
                                                                        ...
                                                                        rent.payments_rents.length) != ((Number(rent.payments_rents[0].pagoRenta)
                                                                            ...
                                                                            Number(rent.payments_rents[0].ivaRenta)) *
                                                                            equipmentObject.paymentsByStatus.Pagado.payments.length)">
                                                            Faltante: <span class="text-green-600">$</span>{{
                                                                loader.precioFormatter(((Number(rent.payments_rents[0].pagoRenta)
                                                                    +
                                                                    Number(rent.payments_rents[0].ivaRenta)) *
                                                    ...
                                                    <div class="mt-4 space-x-2 text-sm text-left">
                                                        <a :href="`${rent.urlEdit}`" Target="_blank"
                                                            class="font-medium text-gray-900 bg-gray-100 hover:bg-gray-200 p-2 rounded-lg">Editar
                                                            Renta</a>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <section aria-labelledby="timeline-title" class="lg:col-span-1 lg:col-start-3">
                    <div class="bg-white px-4 py-5 shadow sm:rounded-lg sm:px-1">
                        <h2 id="timeline-title" class="text-lg font-medium text-gray-900 px-3">Información adicional y
                            herramientas
                        </h2>
                        <div class="flow-root">
                                ...
                                <dl class="grid grid-cols-1 gap-x-1 sm:grid-cols-2">
                                        ...
                                        <div class="relative bg-gray-50 py-6 px-6 rounded-2xl w-64 shadow-xl">
                                            ...
                                            <div class="mt-10">
                                                ...
                                                <div class="flex space-x-2 text-gray-400 text-sm py-2">
                                                    <span
                                                        class="inline-flex items-center gap-1 rounded-full bg-amber-100 px-2 py-1 text-3xl font-semibold text-amber-600"><span
                                                            class="text-amber-600 font-semibold">$</span>{{
                                                                loader.precioFormatter(sumGastosFijos) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                            ...
                                            <div class="mt-10">
                                                ...
                                                <div class="flex space-x-2 text-gray-400 text-sm py-2">
                                                    <span
                                                        class="inline-flex items-center gap-1 rounded-full bg-amber-100 px-2 py-1 text-3xl font-semibold text-amber-600"><span
                                                            class="text-amber-600 font-semibold">$</span>{{
                                                                loader.precioFormatter(sumGastosVariables) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="scale-75 hover:scale-90 duration-200 sm:col-span-2 -my-4">
                                        <div class="relative bg-gray-50 py-6 px-6 rounded-2xl w-65 shadow-xl">
                                            ...
                                            <div class="mt-10">
                                                ...
                                                <div class="flex space-x-2 text-gray-400 text-sm py-2">
                                                    <span
                                                        :class="`inline-flex items-center gap-1 rounded-full ${(utilidadRealTotal > 0) ? 'bg-green-100' : 'bg-yellow-100'} px-2 py-1 text-3xl font-semibold ${(utilidadRealTotal > 0) ? 'text-green-600' : 'text-yellow-600'}`"><span
                                                            :class="`${(utilidadRealTotal > 0) ? 'text-green-600' : 'text-yellow-600'} font-semibold`">$</span>{{
                                                                loader.precioFormatter(utilidadRealTotal) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="scale-75 hover:scale-90 duration-200 sm:col-span-1 -my-8">
                                        <div class="relative bg-gray-50 py-6 px-6 rounded-2xl w-64 shadow-xl">
                                            ...
                                            <div class="mt-10">
                                                <p class="text-xl font-semibold my-2">Calcular Mensualidad Optima y Utilidad
                                                </p>
                                                <div class="flex space-x-2 text-gray-400 text-sm py-2">
                                                    ...
                                                    <p>Ingresa el valor para ver los resultados de renta con respecto a un
                                                ...
                                                <div class="flex justify-between">
                                                    <div class="my-2">
                                                        ...
                                                        <input type="number" pattern="[0-9]+(\.[0-9]+)?" min="0" max="100"
                                                            step="1"
                                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm"
                                                            placeholder="Ingresa porcentaje (%)" v-model="inputPorcentaje">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="relative bg-gray-50 py-6 px-6 rounded-2xl w-64 shadow-xl">
                                            ...
                                            <div class="mt-10">
                                                ...
                                                <div class="flex space-x-2 text-gray-400 text-sm py-2">
                                                    ...
                                                    <p>Ingresa el valor para ver los resultados en su respectivo mes (Por
                                                ...
                                                <div class="flex justify-between">
                                                    <div class="my-2">
                                                        <label class="block text-sm font-medium text-gray-700">Mes De
                                                            Venta Actual</label>
                                                        <input type="number" pattern="[0-9]+(\.[0-9]+)?" min="0" max="48"
                                                            step="1"
                                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm"
                                                            placeholder="Ingresa mes" v-model="inputMes">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="bg-white px-4 py-5 shadow sm:rounded-lg sm:px-1">
                        <article class="Wrapper">
                            <div class="Section px-3 text-center">
                                <button v-bind="toggleAttrs" @click="handleCollapse" :class="[
                                    'Panel',
                                    {
                                        Active: isExpanded,
                                    },
                                    ...
                                    {{ isExpanded ? 'Ocultar' : 'Mostrar' }} Detalles Mensuales Avanzados
                                </button>
                                <Collapse v-bind="collapseAttrs" :when="isExpanded" class="v-collapse">
                                    <p class="text-gray-600 text-base font-sans py-2">
                                        Información detallada sobre el valor del equipo sobre <span class="font-bold">{{
                                            mesesDepEq }}</span> meses de
                                        utilidad óptima
                                    </p>
                                    <!-- Tabla de Detalles -->
                                                ...
                                                <thead class="bg-gray-50">
                                                    <tr>
                                                        <th scope="col"
                                                            ...
                                                            v-for="(columnName, i) in advanceDetaillColumnNames" :key="i">
                                                            {{ columnName }}</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="divide-y divide-gray-200 border-t bg-white">
                                                    <tr class="hover:bg-gray-100" v-for="i in mesesDepEq" :key="i">
                                                        ...
                                                        <td class="whitespace-nowrap px-3 py-2">
                                                            <div
                                                                ...
                                                                {{ Math.round(valorComercialPorc(i) *
                                                                    100) }}<span class="text-green-600">%</span>
                                                            </div>
                                                        </td>
                                                        <td class="whitespace-nowrap px-3 py-2">
                                                            <div
                                                        ...
                                                        <td class="whitespace-nowrap px-3 py-2">
                                                            <div
                                                                ...
                                                                }}<span class="text-green-600">%</span></div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
