...
<div class="relative flex items-start">
    ...
    <div class="ml-3 text-sm">
        <label for="fixedExpensesCatalogs{{ $fixedExpenseCatalog->gastoFijo }}" class="font-medium text-gray-700">{{
            $fixedExpenseCatalog->gastoFijo }}</label>
        ...
        <div class="mt-1">
            <input type="number" name="costoGastoFijo[{{ $i }}]"
                ...
                class="rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm disabled:bg-gray-200"
            ...
            value="{{ old('costoGastoFijo.' . $i,
            $equipment->fixedExpensesCatalogs->contains($fixedExpenseCatalog->clvGastoFijo) ?
            $equipment->fixedExpensesCatalogs->find($fixedExpenseCatalog->clvGastoFijo)->pivot->costoGastoFijo : '0.00')
            }}">
