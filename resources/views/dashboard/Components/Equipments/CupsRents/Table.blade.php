    ...
    <div class="accordion-content px-2 pt-0 overflow-hidden max-h-0 mb-2">
        <div class="bg-white rounded-lg border px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-end gap-4">
                                        <x-Dashboard.IconButton-Show_SA id="CupsRents_{{ $rowCupRent->clvTazaRenta }}"
                                        ...
                                        <x-Dashboard.IconButton-Delete id="CupsRents_{{ $rowCupRent->clvTazaRenta }}"
                                            name="{{ $rowCupRent->tazaRenta }}"
                ...
                {{ $Data['tableCupsRents']['rowCupsRents']->appends(['cupsRents_page' =>
                $Data['tableCupsRents']['rowCupsRents']->currentPage()])->links('vendor.pagination.tailwind') }}
            </div>
            @else
