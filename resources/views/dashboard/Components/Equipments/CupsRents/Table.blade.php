        ...
        <div class="bg-white rounded-lg border px-4 sm:px-6 lg:px-8 py-6">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-xl font-semibold text-gray-900">Tasas De Renta</h1>
                </div>
                <x-Dashboard.Equipments.CupsRents.Button-Create-Modal text="Añadir Tasa De Renta"
            ...
            @else
                <main class="flex items-center justify-center flex-1 px-4 py-8">
                    <!-- Content -->
                    <h1 class="text-5xl font-bold text-gray-500">No hay datos de Tasa De Renta</h1>
                </main>
            @endif
        </div>
    </div>
