<div class='w-full max-w-md mx-auto bg-green-50 rounded-3xl shadow-xl overflow-hidden grid'>
    <div class='h-[236px]'
        style="background-image:url({{ url('/images/John_Deere_Tractor_Uno.jpeg') }});background-size:cover;background-position:center">
    </div>
    <div class='p-4 sm:p-6'>
        ...
        <div class='flex flex-row'>
            ...
            <p class='text-[#3C3C4399] text-[17px] mr-2'>{{ number_format($Data['equipment']['precioEquipo'], 2) }}</p>
        </div>
