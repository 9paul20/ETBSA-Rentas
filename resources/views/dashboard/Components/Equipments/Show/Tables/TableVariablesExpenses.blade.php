                    ...
                    <table
                        ...
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                {{-- @foreach ($Data['tableVariablesExpenses']['columnVariablesExpenses'] as
                                $columnVariableExpense) --}}
                                @foreach ($Data['tableVariablesExpenses']['columnVariablesExpenses']
                                as $columnVariableExpense)
                                <th scope="col"
                        ...
                        <tbody class="divide-y divide-gray-200 border-t  bg-white">
                            ...
                            <tr class="bg-gray-50" id="total-gastos-variables">
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 font-semibold"
                                    ...
                                    {{ $Data['sumVariablesExpenses'] }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                {{ $Data['tableVariablesExpenses']['rowVariablesExpenses']->links('vendor.pagination.tailwind') }}
                {{ $Data['tableVariablesExpenses']['rowVariablesExpenses']->appends(['variablesExpenses_page' =>
                $Data['tableVariablesExpenses']['rowVariablesExpenses']->currentPage()])->links('vendor.pagination.tailwind')
                }}
            </div>
            @else
