        ...
        <div class="bg-white rounded-lg border px-4 sm:px-6 lg:px-8 py-6">
            <div class="sm:flex sm:items-center">
                ...
                <x-Dashboard.Equipments.Category.Button-Create-Modal text="Añadir Categoria"
                    ...
                    SelectTypeCategory="{{ view('Components.Dashboard.Equipments.Category.Selects.SelectCreate-TypeCategories', compact('Data'))->render() }}" />
            </div>
            ...
            <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-end gap-4">
                                        <x-Dashboard.IconButton-Show_SA id="Category_{{ $rowCategory->clvCategoria }}"
                                        ...
                                        <x-Dashboard.Equipments.Category.Button-Edit-Modal
                                            ...
                                            SelectTypeCategory="{{ view('Components.Dashboard.Equipments.Category.Selects.SelectEdit-TypeCategories', ['Data' => $Data, 'clvTipoCategoria' => $rowCategory->clvTipoCategoria])->render() }}" />
                                        <x-Dashboard.IconButton-Delete id="Category_{{ $rowCategory->clvCategoria }}"
                                            name="{{ $rowCategory->categoria }}"
                ...
                {{ $Data['tableCategories']['rowCategories']->appends(['categories_page' =>
                $Data['tableCategories']['rowCategories']->currentPage()])->links('vendor.pagination.tailwind') }}
            </div>
            @else
