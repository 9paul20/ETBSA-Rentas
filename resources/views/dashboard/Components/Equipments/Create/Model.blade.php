                                ...
                                <div class="col-span-6 sm:col-span-6">
                                    ...
                                    <select id="clvCategoria" name="clvCategoria"
                                        ...
                                        <option value="{{ $category['clvCategoria'] }}"
                                            @if($category['clvCategoria']==$Data['equipment']['clvCategoria']) selected
                                            @endif>
                                            {{ $category['categoria'] }}
                                        </option>
                                        @endforeach
