                        ...
                        <div class="bg-white px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-6">
                                    <label for="clvEquipo"
                                        class="block text-sm font-medium text-gray-700">Equipo</label>
                                    <select id="clvEquipo" name="clvEquipo"
                                        ...
                                        <option value="{{ $equipment->clvEquipo }}" @if ($equipment->clvEquipo ==
                                            $rent->clvEquipo) selected @endif>
                                            {{ $equipment->noSerie }}
                                        </option>
                                        @endforeach
                                        @else
                                ...
                                <div class="col-span-6 sm:col-span-6">
                                    ...
                                    <select id="clvCliente" name="clvCliente"
                                        ...
                                        <option value="{{ $client->clvPersona }}" @if ($client->clvPersona ==
                                            $rent->clvCliente) selected @endif>
                                ...
                                <div class="col-span-6 sm:col-span-6">
                                    ...
                                    <select id="clvPagoRenta" name="clvPagoRenta"
                                        ...
                                        <option value="{{ $paymentRent->clvPagoRenta }}" @if ($paymentRent->clvPagoRenta
                                            == $rent->clvPagoRenta) selected @endif>
                                ...
                                <div class="col-span-6 sm:col-span-6">
                                    ...
                                    <select id="clvEstadoRenta" name="clvEstadoRenta"
                                        ...
                                        <option value="{{ $statusRent->clvEstadoRenta }}" @if ($statusRent->
                                            clvEstadoRenta == $rent->clvEstadoRenta) selected @endif>
