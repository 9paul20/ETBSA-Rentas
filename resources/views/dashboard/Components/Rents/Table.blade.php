                        ...
                        @foreach ($rowDatas as $rowData)
                            <tr class="hover:bg-gray-100">
                                <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
                                    <div class="text-sm">
                                        <div class="font-medium text-gray-700">{{ $rowData->clvEquipo }}</div>
                                    </div>
                                </th>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                    <div class="text-gray-600">{{ $rowData->clvCliente }}</div>
                                </td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-end gap-4">
                                        ...
                                        <x-Dashboard.IconButton-Delete id="{{ $rowData->clvRenta }}" name=""
