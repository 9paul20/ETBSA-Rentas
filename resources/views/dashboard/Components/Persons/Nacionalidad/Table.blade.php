    ...
    <div class="accordion-content px-2 pt-0 overflow-hidden max-h-0 mb-2">
        <div class="bg-white rounded-lg border px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
                ...
                {{ $Data['tableNacionalidades']['rowNacionalidades']->appends(['nacionalidades_page' =>
                $Data['tableNacionalidades']['rowNacionalidades']->currentPage()])->links('vendor.pagination.tailwind')
                }}
                @else
