    ...
    <div class="accordion-content px-2 pt-0 overflow-hidden max-h-0 mb-2">
        <div class="bg-white rounded-lg border px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
                ...
                <div class="overflow-x-auto">
                    <table
                        ...
                        <thead class="bg-gray-50">
                            <tr>
                                @foreach ($Data['tableTypeFixedExpensesCatalogs']['columnTypeFixedExpenses']
                                as $columnTypeFixedExpense)
                                <th scope="col"
                        ...
                        <tbody class="divide-y divide-gray-200 border-t  bg-white">
                            @foreach ($Data['tableTypeFixedExpensesCatalogs']['rowTypeFixedExpenses']
                            as $rowFixedExpenseCatalog)
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-end gap-4">
                                        <x-Dashboard.IconButton-Show_SA
                                            ...
                                            description="{{ $rowFixedExpenseCatalog->descripcion }}" href="" />
                ...
                {{ $Data['tableTypeFixedExpensesCatalogs']['rowTypeFixedExpenses']->appends(['statusPaymentsRents_page'
                =>
                $Data['tableTypeFixedExpensesCatalogs']['rowTypeFixedExpenses']->currentPage()])->links('vendor.pagination.tailwind')
                }}
            </div>
            @else
