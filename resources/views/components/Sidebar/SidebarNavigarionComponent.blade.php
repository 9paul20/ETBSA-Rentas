<div class="flex flex-shrink-0 transition-all">
    ...
    <nav aria-label="Options"
        ...
        <button
            ...
            :class="(isSidebarOpen && currentSidebarTab == 'linksTab') ? 'text-white bg-green-600' :
    ...
    <!-- Left mini bar -->
    <nav aria-label="Options"
        class="z-20 flex-col items-center flex-shrink-0 hidden w-16 py-4 bg-white border-r-2 border-green-100 shadow-md sm:flex rounded-tr-3xl rounded-br-3xl">
        <!-- Logo -->
        ...
        <div class="flex flex-col items-center flex-1 p-2 space-y-4">
            ...
            <button
                ...
                class="p-2 transition-colors rounded-lg shadow-md hover:bg-green-800 hover:text-white focus:outline-none focus:ring focus:ring-green-600 focus:ring-offset-white focus:ring-offset-2"
                :class="(isSidebarOpen && currentSidebarTab == 'linksTab') ? 'text-white bg-green-600' :
                '{{ request()->is('Dashboard/Admin*') ? 'text-white bg-green-600' : 'text-gray-500 bg-white' }}'">
                {{-- 'text-gray-500 bg-white'"> --}}
                <span class="sr-only">Toggle sidebar</span>
                <svg aria-hidden="true" class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button
                ...
                class="p-2 transition-colors rounded-lg shadow-md hover:bg-green-800 hover:text-white focus:outline-none focus:ring focus:ring-green-600 focus:ring-offset-white focus:ring-offset-2"
                :class="(isSidebarOpen && currentSidebarTab == 'panelTab') ? 'text-white bg-green-600' :
                '{{ request()->is('Dashboard/Panel/*') ? 'text-white bg-green-600' : 'text-gray-500 bg-white' }}'">
            ...
            <button
                ...
                class="p-2 transition-colors rounded-lg shadow-md hover:bg-green-800 hover:text-white focus:outline-none focus:ring focus:ring-green-600 focus:ring-offset-white focus:ring-offset-2"
                :class="(isSidebarOpen && currentSidebarTab == 'messagesTab') ? 'text-white bg-green-600' :
                'text-gray-500 bg-white'">
    ...
    <div x-transition:enter="transform transition-transform duration-300" x-transition:enter-start="-translate-x-full"
        ...
        class="fixed inset-y-0 left-0 z-10 flex-shrink-0 w-64 bg-white border-r-2 border-green-100 shadow-lg sm:left-14 rounded-tr-3xl rounded-br-3xl sm:w-72 lg:w-64">
        <nav x-show="currentSidebarTab == 'linksTab'" aria-label="Main" class="flex flex-col h-full">
            <!-- Logo -->
            <div class="flex items-center justify-center flex-shrink-0 py-10">
                <a href="{{ route('Dashboard.Menu.Index') }}">
                    <img class="w-24 h-auto" src="{{ url('/images/John_Deere_Logo.png') }}" alt="John_Deere_Logo" />
                </a>
            </div>
            <!-- Title -->
            ...
            <div class="flex-1 px-4 space-y-2 overflow-hidden hover:overflow-auto">
                ...
                <x-Sidebar.ItemNavigation href="Dashboard.Admin.Rents.Index"
                    ...
                    name="Rents" />
                <x-Sidebar.ItemNavigation href="Dashboard.Admin.FixedExpenses.Index"
                    ...
                    name="All Fixed Expenses" />
                <x-Sidebar.ItemNavigation href="Dashboard.Admin.VariablesExpenses.Index"
                    svg="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.486-6.336l-3.276 3.277a3.004 3.004 0 01-2.25-2.25l3.276-3.276a4.5 4.5 0 00-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437l1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008z"
                    name="All Variables Expenses" />
                <x-Sidebar.ItemNavigation href="Dashboard.Admin.MonthlyExpenses.Index"
                    svg="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.486-6.336l-3.276 3.277a3.004 3.004 0 01-2.25-2.25l3.276-3.276a4.5 4.5 0 00-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437l1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008z"
