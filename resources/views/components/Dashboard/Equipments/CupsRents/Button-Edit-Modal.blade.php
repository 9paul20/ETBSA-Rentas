        ...
        <div class="fixed inset-0 z-10 overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div
                    ...
                    <div>
                        <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Editar Taza De Renta
                        </h3>
                    ...
                    <form action="{{ $href }}" class="mt-4 space-y-4" method="POST"
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            <label for="ivaDosMeses" class="block text-sm font-medium text-gray-700">IVA De
                                Dos Meses</label>
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            <label for="ivaTresMeses" class="block text-sm font-medium text-gray-700">IVA De
                                Tres Meses</label>
