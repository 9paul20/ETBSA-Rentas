<div class="col-span-6 sm:col-span-6">
    <label for="clvTipoGastoFijo" class="block text-sm font-medium text-gray-700">Tipo GastoFijo</label>
    <select id="clvTipoGastoFijo" name="clvTipoGastoFijo"
        ...
        @foreach ($Data['allTypeFixedExpense'] as $rowFixedExpense)
        <option value="{{ $rowFixedExpense['clvTipoGastoFijo'] }}">
            {{ $rowFixedExpense['tipoGastoFijo'] }}
        </option>
        @endforeach
        @else
        <option value="" disabled selected>
