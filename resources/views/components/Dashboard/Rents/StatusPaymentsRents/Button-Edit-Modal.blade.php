@props(['id', 'estadoPagoRenta', 'textColor', 'bgColorPrimary', 'bgColorSecondary', 'descripcion', 'href'])
                    ...
                    <form action="{{ $href }}" class="mt-4 space-y-4" method="POST" id="edit-form-{{ $id }}">
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <input type="text" name="estadoPagoRenta" id="estadoPagoRenta-{{ $id }}"
                                ...
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm @error('estadoPagoRenta') border-red-400 @enderror"
                                value="{{ old('estadoPagoRenta', $estadoPagoRenta) }}" required autofocus>
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <input type="text" name="textColor" id="textColor-{{ $id }}" autocomplete="given-textColor"
                                ...
                                value="{{ old('textColor', $textColor) }}" required>
                            @error('textColor')
                            <div class="flex
                                    items-center mt-1 text-red-400">
                                <i class="fas fa-exclamation-triangle mr-2"></i>
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <input type="text" name="bgColorPrimary" id="bgColorPrimary-{{ $id }}"
                                ...
                                value="{{ old('bgColorPrimary', $bgColorPrimary) }}" required>
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <input type="text" name="bgColorSecondary" id="bgColorSecondary-{{ $id }}"
                                ...
                                value="{{ old('bgColorSecondary', $bgColorSecondary) }}" required>
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <textarea rows="3" name="descripcion" id="descripcion-{{ $id }}"
                                ...
                                required>{{ old('descripcion', $descripcion) }}</textarea>
                            @error('descripcion')
                            <div class="flex
                                    items-center mt-1 text-red-400">
                                <i class="fas fa-exclamation-triangle mr-2"></i>
...
<script>
    var editModal{{ $id }} = document.getElementById('edit-modal-{{ $id }}');
            var nombreEstadoPagoRentaInput{{ $id }} = document.getElementById(
                'estadoPagoRenta-{{ $id }}');
            ...
            function openModal{{ $id }}() {
                ...
                nombreEstadoPagoRentaInput{{ $id }}.focus();
            }
