<div class="col-span-6 sm:col-span-6">
    ...
    <select id="clvEstadoPagoRenta" name="clvEstadoPagoRenta"
        ...
        @foreach ($Data['allStatusPaymentsRents'] as $rowStatusPaymentsRents)
        <option value="{{ $rowStatusPaymentsRents->clvEstadoPagoRenta }}">
            {{ $rowStatusPaymentsRents->estadoPagoRenta }}
        </option>
        @endforeach
        @else
        <option value="" disabled selected>
