...
<div class="flex flex-col items-center min-h-scree py-10" style="background-image: linear-gradient(115deg, #9F7AEA, #FEE2FE)">

    <div class="container mx-auto flex-1 h-full mx-auto rounded-lg shadow-xl">
        <!-- Component Start -->
        <h1 class="text-lg text-gray-900 font-medium text-center">2020 IPL Season - Table</h1>
