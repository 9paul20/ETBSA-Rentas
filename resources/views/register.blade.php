            ...
            <div class="flex flex-col lg:flex-row rounded-xl mx-auto shadow-lg ">
                ...
                <div class="w-full lg:w-1/2 py-16 px-12 text-center">
                    ...
                    <form action="#">
                        ...
                        <div class="mt-5">
                            <button
                                class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-500 border border-transparent rounded-lg active:bg-purple-500 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">Register
                                Now</button>
                        </div>
                    </form>
                </div>
